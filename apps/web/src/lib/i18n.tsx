...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    channels: {
      ...
      description: "Subscribe to YouTube channels, browse their latest videos, and batch-add new ones to the download task queue. Already-processed videos are skipped automatically.",
      channelsLabel: "Channel URLs (one per line)",
      channelsPlaceholder: "https://www.youtube.com/@ChannelName",
      limitLabel: "Videos per channel",
      submit: "Fetch & add to tasks",
      submitting: "Fetching...",
      running: "Fetching videos and adding tasks...",
      done: "Import finished",
      failed: "Import failed",
      progress: "Processed {{processed}} / {{total}} channels",
      created: "{{count}} new tasks added",
      skipped: "{{count}} already downloaded (skipped)",
      viewTasks: "View tasks",
      backToHome: "Back to home",
      error: "Failed to start import",
      subscriptionsTitle: "Subscribed channels",
      removeSubscription: "Remove subscription",
      removeTitle: "Remove this subscription?",
      removeDescription: "This will unsubscribe from the channel and remove its local subscription records. This cannot be undone.",
      removing: "Removing",
      confirmRemove: "Confirm remove",
      subscribeLabel: "Channel or video URL",
      subscribePlaceholder: "https://www.youtube.com/@ChannelName or video URL",
      subscribe: "Subscribe",
      groupLabel: "Group",
      groupPlaceholder: "Leave empty for the default group",
      defaultGroup: "Default",
      processAll: "Add latest videos from all channels",
      refreshAll: "Refresh all channels",
      refreshProgress: "Refreshing {{processed}} / {{total}} channels",
      refreshDone: "All channels refreshed",
      batchTitle: "Batch add videos",
      batchDescription: "Add each channel's latest videos to the download task queue. Videos that were already processed are skipped.",
      openChannel: "Open channel",
      openChannelUrl: "Open channel URL",
      noSubscriptions: "No subscribed channels yet.",
      ...
      playTranslated: "Translated video",
      playOriginal: "Original video",
      playOnYouTube: "Play on YouTube",
      openTaskDetail: "Open task",
      folderError: "Unable to open folder",
      videoNotAvailable: "Video is not available yet.",
    },
  },
  zh: {
    common: {
    ...
    channels: {
      title: "频道订阅",
      description: "订阅 YouTube 频道，浏览最新视频，并将新视频批量加入下载任务队列。已处理过的视频会自动跳过。",
      channelsLabel: "频道 URL（每行一个）",
      channelsPlaceholder: "https://www.youtube.com/@频道名",
      limitLabel: "每个频道视频数量",
      submit: "抓取并加入任务",
      submitting: "抓取中...",
      running: "正在抓取视频并添加任务...",
      ...
      failed: "导入失败",
      progress: "已处理 {{processed}} / {{total}} 个频道",
      created: "新增 {{count}} 个任务",
      skipped: "跳过 {{count}} 个已下载视频",
      viewTasks: "查看任务",
      backToHome: "返回首页",
      error: "启动导入失败",
      subscriptionsTitle: "已订阅频道",
      removeSubscription: "取消订阅",
      removeTitle: "确认取消订阅该频道？",
      removeDescription: "这将取消订阅该频道，并删除其本地的订阅记录。此操作无法撤销。",
      removing: "删除中",
      confirmRemove: "确认删除",
      subscribeLabel: "频道链接或视频链接",
      subscribePlaceholder: "https://www.youtube.com/@频道名 或 视频链接",
      subscribe: "订阅",
      groupLabel: "分组",
      groupPlaceholder: "不填则归入默认分组",
      defaultGroup: "默认分组",
      processAll: "添加所有频道的最新视频",
      refreshAll: "刷新所有频道",
      refreshProgress: "正在刷新 {{processed}} / {{total}} 个频道",
      refreshDone: "所有频道已刷新",
      batchTitle: "批量添加视频",
      batchDescription: "将每个频道的最新视频加入下载任务队列，已处理过的视频会自动跳过。",
      openChannel: "打开频道",
      openChannelUrl: "打开频道地址",
      noSubscriptions: "还没有订阅的频道。",
      loadingChannel: "加载频道中...",
      videoCount: "个视频",
      downloadedCount: "个已下载",
      noVideos: "未找到视频。",
      downloaded: "已下载",
      addToTasks: "加入任务",
      refresh: "刷新",
      ...
      playTranslated: "翻译视频",
      playOriginal: "原始视频",
      playOnYouTube: "播放 YouTube",
      openTaskDetail: "查看任务",
      folderError: "打开文件夹失败",
      videoNotAvailable: "视频尚未就绪。",
    },
  },
}
