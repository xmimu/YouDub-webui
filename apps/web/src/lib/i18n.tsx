...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    home: {
      ...
      autoUploadBilibili: "Upload to Bilibili when complete",
      autoUploadBilibiliHelp: "Available for URL tasks after Bilibili login and category setup.",
      localUploadBilibiliDisabled: "Local video tasks cannot be submitted as reposts.",
    ...
    task: {
      ...
      download: "Download",
      bilibiliUpload: "Upload to Bilibili",
      bilibiliUploading: "Uploading to Bilibili",
      bilibiliUploadQueued: "Bilibili upload is queued.",
      bilibiliUploadSucceeded: "Submitted to Bilibili.",
      bilibiliUploadFailed: "Bilibili upload failed.",
      bilibiliUploadUnknown: "The upload outcome is unknown. Check Bilibili before taking further action.",
      bilibiliUploadError: "Failed to start Bilibili upload",
      bilibiliAutoUpload: "Automatic Bilibili upload",
      bilibiliAutoEnabled: "Enabled",
      stages: "Stages",
    ...
    settings: {
      ...
      bilibiliConnected: "Connected",
      bilibiliDisconnected: "Not connected",
      bilibiliLogin: "Scan QR code to log in",
      bilibiliLoginPending: "Waiting for scan and confirmation...",
      bilibiliLoginFailed: "Bilibili login failed",
      bilibiliDisconnect: "Disconnect",
      bilibiliDefaultTid: "Default Bilibili category ID",
      bilibiliDefaultTidHelp: "Required for uploading. Enter the numeric tid for your target category.",
      selectZone: "Select category",
      saveSucceeded: "Saved",
      saveFailed: "Failed",
  ...
  zh: {
    ...
    home: {
      ...
      autoUploadBilibili: "完成后自动投稿到 Bilibili",
      autoUploadBilibiliHelp: "仅 URL 任务可用，需先登录 Bilibili 并配置投稿分区。",
      localUploadBilibiliDisabled: "本地视频任务不能作为转载稿自动投稿。",
      taskHistory: "任务历史",
    ...
    task: {
      ...
      finalVideo: "最终视频",
      download: "下载",
      bilibiliUpload: "投稿到 Bilibili",
      bilibiliUploading: "正在投稿到 Bilibili",
      bilibiliUploadQueued: "Bilibili 投稿正在排队。",
      bilibiliUploadSucceeded: "已提交到 Bilibili。",
      bilibiliUploadFailed: "Bilibili 投稿失败。",
      bilibiliUploadUnknown: "投稿结果未知，请先前往 Bilibili 创作中心确认，避免重复投稿。",
      bilibiliUploadError: "启动 Bilibili 投稿失败",
      bilibiliAutoUpload: "自动投稿到 Bilibili",
      bilibiliAutoEnabled: "已开启",
      stages: "处理阶段",
    ...
    settings: {
      ...
      bilibiliSaveSection: "Bilibili 设置",
      bilibiliAccount: "Bilibili 账号",
      bilibiliConnected: "已连接",
      bilibiliDisconnected: "未连接",
      bilibiliLogin: "扫码登录 Bilibili",
      bilibiliLoginPending: "等待扫码并确认...",
      bilibiliLoginFailed: "Bilibili 登录失败",
      bilibiliDisconnect: "断开连接",
      bilibiliDefaultTid: "默认 Bilibili 投稿分区 ID",
      bilibiliDefaultTidHelp: "投稿必填，请输入目标分区的数字 tid。",
      selectZone: "选择分区",
      saveSucceeded: "保存成功",
      saveFailed: "保存失败",
      saveUnchanged: "未修改",
